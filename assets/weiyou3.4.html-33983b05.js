import{_ as e,o as d,c as i,e as n}from"./app-58c21a21.js";const a={},t=n(`<h3 id="解析器速度提高-2-倍-优化-sfc-的构建性能" tabindex="-1"><a class="header-anchor" href="#解析器速度提高-2-倍-优化-sfc-的构建性能" aria-hidden="true">#</a> 解析器速度提高 2 倍，优化 SFC 的构建性能</h3><pre><code>在 Vue 3.4 中，我们完全重写了模板解析器。之前，Vue 使用递归下降解析器，该解析器依赖一大坨正则表达式和前向搜索。新的解析器使用基于 htmlparser2 的状态机 tokenizer（分词器），它有且仅有迭代整个模板字符串一次。结果是对于所有尺寸的模板而言，解析器始终优化 2 倍。多亏了我们广泛的测试用例和 ecosystem-ci，它也 100% 向后兼容 Vue 终端用户。
