import{_ as e,o as i,c as n,e as s}from"./app-58c21a21.js";const a={},d=s(`<h2 id="使用uview-plus" tabindex="-1"><a class="header-anchor" href="#使用uview-plus" aria-hidden="true">#</a> 使用uview-plus</h2><h4 id="一、下载插件并导入hbuilderx" tabindex="-1"><a class="header-anchor" href="#一、下载插件并导入hbuilderx" aria-hidden="true">#</a> 一、下载插件并导入HBuilderX</h4><pre><code>在uniapp插件市场搜索\`uview plus\`，选择插件后点击右边的\`下载插件并导入HBuilderX\`选择刚创建的项目进行导入即可
